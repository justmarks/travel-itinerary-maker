...
- **See [`docs/parity-contract.md`](docs/parity-contract.md)** for the standing inventory of desktop ↔ mobile file pairs by surface, the shared modules that prevent drift, and the known intentional gaps. Update it when adding a new parallel surface.
