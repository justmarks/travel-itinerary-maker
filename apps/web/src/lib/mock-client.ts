...
const SAMPLE_TRIPS: Trip[] = [
  // ── Demo 1: Japan Adventure ───────────────────────────────────────────────
  {
    ...
    todos: [
      ...
      { id: "todo-3", text: "Research best ramen spots in Tokyo", isCompleted: false, category: "meals", sortOrder: 2, details: "- **Ichiran** (Shibuya & Shinjuku) — classic tonkotsu\n- **Afuri** (Ebisu) — yuzu shio, try the [limited spring menu](https://afuri.com/menu/)\n- **Fu-unji** (Nishi-Shinjuku) — tsukemen, get there before noon to skip the line" },
  ...
  // A future trip — the only one in SAMPLE_TRIPS whose dates are after
  // currentDate. Lets the demo show what an in-progress "planning" trip
  // looks like alongside the completed retrospectives.
  {
    id: "demo-4",
        ...
        segments: [
          {
            ...
            arrivalCity: "Reykjavík",
            carrier: "Icelandair",
            routeCode: "FI680",
            startTime: "16:40",
            endTime: "06:30",
            confirmationCode: "FI-ICEX42",
            seatNumber: "22A, 22B, 22C",
            cabinClass: "Economy",
            baggageInfo: "1 checked bag per passenger",
            cost: { amount: 2850, currency: "USD", details: "Economy · 3 seats, nonstop" },
            source: "email_confirmed",
            needsReview: false,
            sortOrder: 0,
        ...
        segments: [
          {
            id: "seg-i2",
            type: "car_rental",
            title: "Blue Car Rental · Subaru Forester AWD",
            venueName: "Blue Car Rental — Keflavík Airport",
            address: "Blikavöllur 3, 235 Keflavík",
            startTime: "07:30",
            endDate: "2026-07-22",
            endTime: "10:00",
            confirmationCode: "BLU-2026-RYK-9981",
            contactName: "Pickup desk (Terminal 1)",
            cost: { amount: 920, currency: "USD", details: "AWD SUV · 4 days · full insurance" },
            source: "email_confirmed",
            needsReview: false,
            sortOrder: 0,
          ...
          },
          {
            id: "seg-i3",
            type: "hotel",
            title: "Check-in · Reykjavík Konsulat Hotel",
            venueName: "Reykjavík Konsulat Hotel, Curio Collection by Hilton",
            address: "Hafnarstræti 17–19, 101 Reykjavík",
            startTime: "15:00",
            endTime: "11:00",
            endDate: "2026-07-20",
            breakfastIncluded: true,
            confirmationCode: "HH-KONS-44992",
            cost: { amount: 420, currency: "USD", details: "Deluxe King · 1 night · breakfast included" },
            source: "email_confirmed",
            needsReview: false,
            sortOrder: 1,
            url: "https://www.hilton.com/en/hotels/keficqq-reykjavik-konsulat-hotel/",
          },
          {
            id: "seg-i4",
            type: "activity",
          ...
          },
          {
            ...
            partySize: 3,
            creditCardHold: true,
            cancellationDeadline: "2026-07-17",
            phone: "+354 552 1522",
            cost: { amount: 48000, currency: "ISK", details: "Tasting menu · 3 guests" },
            source: "manual",
            needsReview: false,
            sortOrder: 3,
            url: "https://www.dillrestaurant.is/",
          },
        ],
      },
      {
        ...
        segments: [
          {
            id: "seg-i6",
            type: "tour",
            title: "Golden Circle self-drive · Þingvellir, Geysir, Gullfoss",
            startTime: "09:00",
            endTime: "16:30",
            cost: { amount: 0, currency: "USD", details: "Self-drive — no booking required" },
            source: "manual",
            needsReview: false,
            sortOrder: 0,
          },
          {
            id: "seg-i7",
            type: "activity",
            title: "Secret Lagoon Hot Spring",
            venueName: "Secret Lagoon (Gamla Laugin)",
            address: "Hvammsvegur, 845 Flúðir",
            startTime: "17:00",
            endTime: "18:30",
            partySize: 3,
            cost: { amount: 9000, currency: "ISK", details: "3 adults" },
            source: "manual",
            needsReview: false,
            sortOrder: 1,
          ...
          },
          {
            id: "seg-i8",
            type: "hotel",
            title: "Check-in · Hotel Selfoss",
            venueName: "Hotel Selfoss",
            address: "Eyravegur 2, 800 Selfoss",
            startTime: "19:30",
            endTime: "11:00",
            endDate: "2026-07-21",
            breakfastIncluded: true,
            confirmationCode: "HSF-881122",
            cost: { amount: 260, currency: "USD", details: "Superior Twin · 1 night" },
            source: "email_confirmed",
            needsReview: false,
            sortOrder: 2,
            url: "https://www.hotelselfoss.is/",
          },
        ],
      },
      {
        ...
        segments: [
          ...
          },
          {
            id: "seg-i10",
            type: "restaurant_lunch",
            title: "Black Beach Restaurant",
            venueName: "Black Beach Restaurant",
            address: "Reynisfjara Beach, 871 Vík í Mýrdal",
            startTime: "13:30",
            partySize: 3,
            phone: "+354 571 2718",
            cost: { amount: 22000, currency: "ISK", details: "Lunch · 3 guests" },
            source: "manual",
            needsReview: false,
            sortOrder: 1,
          },
          {
            id: "seg-i11",
            type: "tour",
            title: "Sólheimajökull glacier walk (Arctic Adventures)",
            venueName: "Arctic Adventures — Sólheimajökull base camp",
            startTime: "15:00",
            endTime: "18:30",
            confirmationCode: "AA-GLCR-7781",
            partySize: 3,
            cost: { amount: 33000, currency: "ISK", details: "Glacier Discovery · 3 guests · crampons included" },
            source: "email_confirmed",
            needsReview: false,
            sortOrder: 2,
          ...
          },
          {
            id: "seg-i12",
            type: "hotel",
            title: "Check-in · Hotel Kría",
            venueName: "Hotel Kría",
            address: "Suðurvíkurvegur 5, 870 Vík",
            startTime: "19:00",
            endTime: "11:00",
            endDate: "2026-07-22",
            breakfastIncluded: true,
            confirmationCode: "HKR-55678",
            cost: { amount: 310, currency: "USD", details: "Family room · 1 night" },
            source: "email_confirmed",
            needsReview: false,
            sortOrder: 3,
            url: "https://www.hotelkria.is/",
          },
        ],
      },
      {
        ...
        segments: [
          {
            id: "seg-i13",
            type: "car_service",
            title: "Drop car · Blue Car Rental KEF",
            venueName: "Blue Car Rental — Keflavík Airport return",
            startTime: "09:30",
            source: "manual",
            needsReview: false,
            sortOrder: 0,
          },
          {
            ...
            seatNumber: "22A, 22B, 22C",
            cabinClass: "Economy",
            cost: { amount: 0, currency: "USD", details: "Return leg (same PNR as outbound)" },
            source: "email_confirmed",
            needsReview: false,
            sortOrder: 1,
            url: "https://www.icelandair.com/",
    ...
    todos: [
      { id: "todo-i1", text: "Confirm Blue Lagoon entry time", isCompleted: true, category: "activities", sortOrder: 0 },
      { id: "todo-i2", text: "Download offline Google Maps for Ring Road", isCompleted: false, category: "logistics", sortOrder: 1 },
      { id: "todo-i3", text: "Book Dill 3 months in advance (hard to get)", isCompleted: true, category: "meals", sortOrder: 2 },
      { id: "todo-i4", text: "Pack waterproof layers and sturdy hiking boots", isCompleted: false, category: "logistics", sortOrder: 3 },
      { id: "todo-i5", text: "Check Icelandic driving rules (F-roads require 4x4)", isCompleted: false, category: "research", sortOrder: 4 },
      { id: "todo-i6", text: "Buy travel insurance with glacier activity coverage", isCompleted: false, category: "logistics", sortOrder: 5 },
